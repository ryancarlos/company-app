...
<html lang="en">
  <head>
    ...
    <link href="css/unltd.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <h1>Conference Room Map</h1>
        <p class="lead">Shot of Entrance</p>
...
<!--<img src="images/Conference-Rooms-Map.jpg" width="800" height="619" alt="" border="0" padding:"5px" style="display:block;">-->
    ...
    <script>window.jQuery || document.write('<script src="http://code.jquery.com/jquery-3.1.1.min.js"  integrity="sha256-hVVnYaiADRTO2PzUGmuLJr8BLUSjGIZsDYGmIJLv2b8=" crossorigin="anonymous"><\/script>')</script>
